  ...
  if (gameState === "PLAY") {
    ...
    //Incresing coinCount if rocket Touches coins.
     if (bronzeCoinGroup.isTouching(rocket)) {
      ...
      comet.velocityY += 0.05;
      bronzeCoin.velocityY += 0.05; 
    }
     ...
     if (silverCoinGroup.isTouching(rocket)) {
      ...
      comet.velocityY += 0.75;
      silverCoin.velocityY += 0.75; 
    }
...
function spawnBronzeCoins() {
  if (frameCount % 150 === 0) {
    ...
    console.log(bronzeCoin.VelocityY);
...
function spawnSilverCoins() {
  if (frameCount % 715 === 0) {
    ...
    console.log(silverCoin.VelocityY);
...
function spawnGoldCoins() {
  if (frameCount % 1716 === 0) {
    ...
    goldCoin.scale = 0.05;
    console.log(goldCoin.VelocityY);
